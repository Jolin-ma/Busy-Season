...
- **First-month structure (decided 2026-08-15):** billed as a **$750 setup deposit** due at signing (covers onboarding + the first biweekly batch of 4 videos, delivered within ~2 weeks) and a **$750 first invoice** due when the second batch of 4 is delivered (~day 30). Together these still total $1,500 for month 1 — identical to every month after — this is a labeling change only, not a price cut: it replaces the confusing "$750 deposit, then another $750 later in the same month" framing with two clearly-named, clearly-timed payments. Both first-month payments default to Interac e-Transfer; Stripe is available on either one only if the client specifically asks to pay by card (Section 2.4). From month 2 onward, the full $1,500 auto-bills each month, by e-transfer by default or Stripe if the client requests card (Section 2.4).
...
- [x] Decide Growth retainer first-month payment structure — resolved 2026-08-15: kept at $1,500 total for month 1 (no revenue given up), relabeled as a $750 setup deposit + $750 first invoice rather than "$750 deposit, $750 balance," to make the pricing easier for a prospect to follow while still delivering the first batch within ~2 weeks (Section 2.2)
